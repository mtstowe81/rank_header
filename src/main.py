# Please write a program that analyzes HTTP responses from the top 1000 sites in that list. 
#
...
if __name__ == '__main__':
    ...
    parser.add_argument('--display_graph', default=True, type=bool, help='Display the graph', choices=[True,False])
